...
DEFAULT_CKPT_DIR = Path(__file__).resolve().parents[1] / "data/ckpts"
DEFAULT_NEG_PROMPT_EMBED_PATH = DEFAULT_CKPT_DIR / "robosuite_default_neg_prompt.pt"
DEFAULT_PROMPT_EMBED_PATH = DEFAULT_CKPT_DIR / "robosuite_default_prompt.pt"
